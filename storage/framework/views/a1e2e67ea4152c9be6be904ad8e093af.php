            ...
            <?php if($tiles->isNotEmpty()): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <?php $__currentLoopData = $tiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $c = $colorMap[$tile['color']] ?? $colorMap['indigo']; ?>
                        <a href="<?php echo e(route($tile['route'])); ?>"
                           class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-4 <?php echo e($c['border']); ?> hover:<?php echo e($c['bg']); ?> transition-colors duration-150 group">
                            <div class="p-5">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="mt-1 text-sm font-semibold <?php echo e($c['text']); ?>">
                                            <?php echo e($tile['stat']); ?>
                                        ...
                                        <?php if(array_key_exists('scheduler_ok', $tile)): ?>
                                            <p class="mt-1 text-xs font-medium <?php echo e($tile['scheduler_ok'] ? 'text-green-600' : 'text-red-500'); ?>">
                                                ● Scheduler <?php echo e($tile['scheduler_ok'] ? 'aktiv' : 'nicht aktiv'); ?>

                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="<?php echo e($c['icon']); ?> ml-3 flex-shrink-0">
                                        <svg class="h-8 w-8 opacity-70 group-hover:opacity-100 transition-opacity"
                                             fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="<?php echo e($iconPaths[$tile['icon']] ?? $iconPaths['cart']); ?>" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
            ...
            <?php if($widgets->isNotEmpty()): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $widgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $widget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if (isset($component)) { $__componentOriginal3ec39559beef94f2ae0afaa913c0672c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3ec39559beef94f2ae0afaa913c0672c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.module-widget','data' => ['viewPath' => $widget['viewPath']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('module-widget'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['viewPath' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($widget['viewPath'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3ec39559beef94f2ae0afaa913c0672c)): ?>
<?php $attributes = $__attributesOriginal3ec39559beef94f2ae0afaa913c0672c; ?>
<?php unset($__attributesOriginal3ec39559beef94f2ae0afaa913c0672c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal3ec39559beef94f2ae0afaa913c0672c)): ?>
<?php $component = $__componentOriginal3ec39559beef94f2ae0afaa913c0672c; ?>
<?php unset($__componentOriginal3ec39559beef94f2ae0afaa913c0672c); ?>
<?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php endif; ?>

            <?php if($tiles->isEmpty() && $widgets->isEmpty() && $announcements->isEmpty()): ?>
