...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
    <div class="p-6">
        ...
        <?php if($hasVlans): ?>
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                    ...
                    <span class="text-sm font-medium text-gray-900"><?php echo e($totalIpCount); ?></span>
                </div>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="mt-4">
                <?php if(auth()->user()->role === 'super-admin' || auth()->user()->can('network.edit')): ?>
                    <a href="<?php echo e(route('network.vlans.create')); ?>" 
                       class="block w-full text-center bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-4 rounded transition-colors">
                        Create VLAN
                    </a>
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\itcockpit\new\app\Modules/Network/Views/components/dashboard-widget.blade.php ENDPATH**/ ?>