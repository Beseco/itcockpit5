...
<div class="max-w-lg w-full">
    ...
    <div class="bg-white rounded-b-xl shadow border border-t-0 border-gray-200 px-8 py-10 text-center">
        ...
        <h2 class="text-xl font-bold text-gray-800 mb-3">Revision abgeschlossen</h2>
        <p class="text-gray-500 leading-relaxed text-sm">
            Vielen Dank für Ihre Rückmeldung!<br>
            Die IT-Abteilung wird die eingegangenen Vorschläge prüfen<br>
            und sich gegebenenfalls bei Ihnen melden.
        </p>
    </div>
