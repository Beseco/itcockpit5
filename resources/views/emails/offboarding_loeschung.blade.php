<!DOCTYPE html>
<html lang="de">
<head><meta charset="UTF-8"><title>Offboarding Löschung</title></head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                <tr>
                    <td style="background:#dc2626;border-radius:8px 8px 0 0;padding:24px 32px;">
                        <span style="font-size:11px;color:#fca5a5;text-transform:uppercase;letter-spacing:1px;font-weight:600;">IT Cockpit · Offboarding</span>
                        <h1 style="margin:6px 0 0;font-size:20px;font-weight:700;color:#ffffff;">Löschung erforderlich (60 Tage)</h1>
                    </td>
                </tr>
                <tr>
                    <td style="background:#ffffff;padding:32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                        ...
                        <p style="margin:0 0 16px;line-height:1.7;">
                            60 Tage nach dem Ausscheiden von <strong>{{ $record->voller_name }}</strong> sind erreicht.
                            Bitte löschen Sie nun alle Daten (Benutzerkonto, Postfach, Serverlaufwerke, Terminalserver-Profil)
                        ...
                        <div style="background:#dcfce7;border:1px solid #16a34a;border-radius:6px;padding:12px 16px;margin:0 0 20px;">
                            ...
                            <span style="color:#166534;">Das Konto ist im Active Directory nicht mehr vorhanden.</span>
                        </div>
                        @else
                        <div style="background:#fee2e2;border:1px solid #dc2626;border-radius:6px;padding:12px 16px;margin:0 0 20px;">
                            <strong style="color:#991b1b;">⚠ LDAP-Prüfung:</strong>
                            <span style="color:#7f1d1d;">Das Konto ist im Active Directory noch vorhanden – bitte jetzt löschen.</span>
                        </div>
                        @endif
                        ...
                        <table cellpadding="0" cellspacing="0" style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:6px;padding:16px;margin:0 0 24px;width:100%;">
                            ...
                            <tr><td style="padding:3px 0;font-size:13px;color:#6b7280;">Ausgeschieden am:</td>
                                <td style="font-size:13px;">{{ $record->datum_ausscheiden->format('d.m.Y') }}</td></tr>
                            <tr><td style="padding:3px 0;font-size:13px;color:#6b7280;">Löschfrist:</td>
                                <td style="font-size:13px;font-weight:600;color:#dc2626;">{{ $record->datum_ausscheiden->addDays(60)->format('d.m.Y') }}</td></tr>
                        </table>
