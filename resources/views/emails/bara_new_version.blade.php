...
<head>
    ...
    <title>Neue Baramundi-Version erkannt</title>
</head>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <p style="margin:0 0 20px;line-height:1.7;color:#374151;">
                                Für das Paket <strong>{{ $package->name }}</strong> wurde eine neue Version erkannt.
                                Die Installationsdateien sind möglicherweise noch nicht vorhanden und müssen manuell bereitgestellt werden.
                            </p>

                            {{-- Versions-Box --}}
                            <table width="100%" cellpadding="0" cellspacing="0"
                                   style="background:#eef2ff;border:1px solid #a5b4fc;border-radius:8px;margin-bottom:24px;">
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <div style="font-size:11px;text-transform:uppercase;letter-spacing:0.5px;color:#3730a3;font-weight:600;margin-bottom:8px;">Paket</div>
                                        <div style="font-size:20px;font-weight:700;color:#3730a3;margin-bottom:16px;">{{ $package->name }}</div>

                                        <table cellpadding="0" cellspacing="0" style="font-size:13px;color:#3730a3;width:100%;">
                                            <tr>
                            ...
                            <p style="margin:0 0 8px;line-height:1.7;color:#374151;font-weight:600;">
                                Bitte prüfen und Installationsdateien bereitstellen.
                            </p>
                            <p style="margin:0;line-height:1.7;color:#6b7280;font-size:13px;">
                                Baramundi hat den Versionsordner automatisch angelegt. Die eigentlichen Installationsdateien
                                (z.&nbsp;B. .msi, .exe) müssen für lizenzpflichtige Software manuell in den Ordner kopiert werden,
                                bevor die automatische Software-Verteilung greifen kann.
                            </p>
