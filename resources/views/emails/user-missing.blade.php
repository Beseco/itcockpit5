...
<head>
    ...
    <title>Wir vermissen Sie im IT-Cockpit</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td style="background:#4f46e5;border-radius:8px 8px 0 0;padding:24px 32px;">
                            ...
                            <h1 style="margin:6px 0 0;font-size:20px;font-weight:700;color:#ffffff;line-height:1.3;">Wir vermissen Sie!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <p style="margin:0 0 20px;line-height:1.7;color:#374151;">
                                Sie waren seit <strong>{{ $inactiveDays }} Tagen</strong> nicht mehr im <strong>IT-Cockpit</strong>
                                des Landratsamts Freising aktiv. Das IT-Cockpit ist Ihre zentrale Plattform zur Verwaltung der IT-Infrastruktur –
                                vielleicht warten aktuelle Informationen auf Sie.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                                <tr>
                                    <td style="border-left:3px solid #4f46e5;padding:12px 16px;background:#f5f3ff;border-radius:0 4px 4px 0;font-size:14px;color:#374151;line-height:1.6;">
                                        Im IT-Cockpit finden Sie aktuelle Netzwerk- und VLAN-Übersichten,
                            ...
                            <p style="margin:0 0 24px;font-size:13px;color:#6b7280;line-height:1.6;">
                                Passwort vergessen?
                                <a href="{{ config('app.url') . '/forgot-password' }}" style="color:#4f46e5;text-decoration:underline;">Passwort zurücksetzen</a>
                            </p>
                                ...
                                <tr>
                                    <td style="background:#fffbeb;border:1px solid #fcd34d;border-radius:6px;padding:14px 18px;">
                                        <p style="margin:0;font-size:13px;color:#78350f;line-height:1.6;">
                                            ...
                                            Wenn Sie diese E-Mail nicht mehr erhalten möchten, wenden Sie sich ebenfalls an die IT.
                                        </p>
                                    </td>
                                </tr>
                            </table>
