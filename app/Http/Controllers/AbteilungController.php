...
class AbteilungController extends Controller
{
    ...
    public function index()
    {
        ...
        $abteilungen = Abteilung::with(['children.children.children', 'parent'])
            ->roots()
            ->get();
    ...
    public function create()
    {
        ...
        return view('abteilungen.create', compact('allAbteilungen'));
    }
    ...
    public function edit(Abteilung $abteilung)
    {
        ...
        // Eigene Nachkommen aus dem Dropdown ausschließen (kein Kreisbezug)
        ...
        return view('abteilungen.edit', compact('abteilung', 'allAbteilungen'));
    }
