                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" required
                                        ...
                                        <option value="geplant"   {{ old('status', 'produktiv') === 'geplant'   ? 'selected' : '' }}>Geplant</option>
                                        <option value="produktiv" {{ old('status', 'produktiv') === 'produktiv' ? 'selected' : '' }}>Produktiv</option>
                                        <option value="eol"       {{ old('status', 'produktiv') === 'eol'       ? 'selected' : '' }}>EOL</option>
                                        <option value="geloescht" {{ old('status', 'produktiv') === 'geloescht' ? 'selected' : '' }}>Gelöscht</option>
                                    </select>
                                    ...
                                    <div x-show="enabled" x-cloak class="border border-blue-100 bg-blue-50 rounded-lg p-4 space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center">
                                                <input id="dhcp_from" type="text" name="dhcp_from" value="{{ old('dhcp_from') }}" placeholder="Von z.B. 192.168.1.100" oninput="validateDhcp()" x-bind:disabled="!enabled" x-bind:required="enabled"
                                                       class="flex-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" />
                                                <span class="text-gray-500 text-sm">–</span>
                                                <input id="dhcp_to" type="text" name="dhcp_to" value="{{ old('dhcp_to') }}" placeholder="Bis z.B. 192.168.1.200" oninput="validateDhcp()" x-bind:disabled="!enabled" x-bind:required="enabled"
                                                       class="flex-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" />
                                            </div>
