                                    ...
                                    <div x-show="enabled" x-cloak class="border border-blue-100 bg-blue-50 rounded-lg p-4 space-y-3">
                                        ...
                                        <div x-show="servers.length > 0">
                                            ...
                                            <select name="dhcp_server_id"
                                                ...
                                                <template x-for="srv in servers" :key="srv.id">
                                                    <option :value="srv.id"
                                                            :selected="srv.id == {{ old('dhcp_server_id', $vlan->dhcp_server_id ?? 0) }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2 items-center">
                                                <x-text-input id="dhcp_from" class="flex-1" type="text" name="dhcp_from" :value="old('dhcp_from', $vlan->dhcp_from)" placeholder="Von z.B. 192.168.1.100" oninput="validateDhcp()" required />
                                                <span class="text-gray-500 text-sm">–</span>
                                                <x-text-input id="dhcp_to" class="flex-1" type="text" name="dhcp_to" :value="old('dhcp_to', $vlan->dhcp_to)" placeholder="Bis z.B. 192.168.1.200" oninput="validateDhcp()" required />
                                            </div>
