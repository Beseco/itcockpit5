    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('sslcerts.help') }}" title="Hilfe & Anleitung"
            ...
            <div class="flex items-center gap-2">
                @can('sslcerts.config')
                <a href="{{ route('sslcerts.settings') }}"
                   class="inline-flex items-center px-3 py-2 bg-gray-100 text-gray-600 text-sm font-medium rounded-md hover:bg-gray-200">
