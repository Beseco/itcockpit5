<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800">Vertragsmanagement – Neuer Vertrag</h2>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('vertragsmanagement.store') }}" class="space-y-5" enctype="multipart/form-data">
                    @csrf

                    @include('vertragsmanagement::_form')

                    <div class="pt-4 border-t border-gray-100 flex justify-end gap-3">
                        <a href="{{ route('vertragsmanagement.index') }}"
                        ...
                        <x-primary-button type="submit">Vertrag anlegen</x-primary-button>
                    </div>
                </form>
            </div>
        </div>
