<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800">Entsorgungseintrag bearbeiten</h2>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('entsorgung.update', $eintrag) }}">
                    @csrf
                    @method('PUT')
                    @include('entsorgung::_form', ['eintrag' => $eintrag])
